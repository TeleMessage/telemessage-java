...
public class RecipientStatus  implements java.io.Serializable {
    ...
    private generatedV01.Recipient recipient;
    ...
    public RecipientStatus(
           ...
           generatedV01.Recipient recipient,
           int status,
           long statusDate) {
     ...
     * @return recipient
     */
    public generatedV01.Recipient getRecipient() {
        return recipient;
    }
     ...
     * @param recipient
     */
    public void setRecipient(generatedV01.Recipient recipient) {
        this.recipient = recipient;
    }
